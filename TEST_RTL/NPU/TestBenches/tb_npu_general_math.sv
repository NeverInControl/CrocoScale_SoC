...
module tb_npu_general_math;
    ...
    initial begin : main_proc
        ...
        $readmemh("gen_lut_silu.mem",               lut_silu_flat);
        $readmemh("gen_gemm_a.mem",                 raw_gemm_A_flat);
        $readmemh("gen_gemm_b.mem",                 raw_gemm_B_flat);
        $readmemh("gen_gemm_out_raw.mem",           golden_gemm_flat);

        $readmemh("gen_conv1x1_act.mem",            raw_conv1x1_in_flat);
        $readmemh("gen_conv1x1_w.mem",              raw_conv1x1_w_flat);
        $readmemh("gen_conv1x1_out_raw.mem",        golden_conv1x1_raw_flat);
        $readmemh("gen_conv1x1_out_quant.mem",      golden_conv1x1_quant_flat);
        $readmemh("gen_conv1x1_out_lut.mem",        golden_conv1x1_lut_flat);

        $readmemh("gen_conv3x3_halo_act.mem",       raw_conv3x3_halo_in_flat);
        $readmemh("gen_conv3x3_halo_w.mem",         raw_conv3x3_halo_w_flat);
        $readmemh("gen_conv3x3_halo_out_raw.mem",   golden_conv3x3_halo_raw_flat);
        $readmemh("gen_conv3x3_halo_out_quant.mem", golden_conv3x3_halo_quant_flat);
        $readmemh("gen_conv3x3_halo_out_lut.mem",   golden_conv3x3_halo_lut_flat);
